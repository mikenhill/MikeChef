...
CHEF_SERVER_NAME="MikeChefAutomateServer" # The name of your Chef Server
CHEF_SERVER_ENDPOINT="mikechefautomateserver-xmm4fttw3jvoo2k4.eu-west-1.opsworks-cm.io" # The FQDN of your Chef Server
